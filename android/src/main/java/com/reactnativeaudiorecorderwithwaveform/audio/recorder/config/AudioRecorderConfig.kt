package com.reactnativeaudiorecorderwithwaveform.audio.recorder.config
...
import com.reactnativeaudiorecorderwithwaveform.audio.recorder.listener.OnSilentDetectedListener
import com.reactnativeaudiorecorderwithwaveform.audio.recorder.listener.OnTimerCountListener
...
/**
 * Config file of [com.reactnativeaudiorecorderwithwaveform.audio.recorder.AudioRecorder]
 */
class AudioRecorderConfig {
    ...
    /**
     * [OnChunkAvailableListener] called when [com.reactnativeaudiorecorderwithwaveform.audio.recorder.chunk.AudioChunk] is available.
     */
     ...
     *
     * Note, this options need to use [com.reactnativeaudiorecorderwithwaveform.audio.recorder.source.NoiseAudioSource]
     */
     ...
     * when pause recording using [com.reactnativeaudiorecorderwithwaveform.audio.recorder.recorder.AudioRecorder.pauseRecording],
