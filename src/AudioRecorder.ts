...
export function createRecorder(
  ...
  audioEncoding?: AudioEncoderAndroidType,
  frequency?: number,
  bitRate?: FFmpegBitRate,
  samplingRate?: FFmpegSamplingRate,
  mono?: boolean
) {
  NativeAudioRecorder.setupRecorder(
    sourceMode,
    isFFmpegMode,
    isDebug,
...
export function startRecorder(filePath?: string) {
  NativeAudioRecorder.startRecording(filePath);
}
