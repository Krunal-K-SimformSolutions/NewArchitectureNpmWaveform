...
import com.reactnativeaudiorecorderwithwaveform.R
import com.reactnativeaudiorecorderwithwaveform.audio.recorder.model.DebugState
import com.reactnativeaudiorecorderwithwaveform.gradient.getLinearGradientPojo
import kotlin.math.*
...
open class WaveformSeekBar @JvmOverloads constructor(
    ...
    init  {
        ...
        with(progressProps) {
          ...
          isRecorder = ta.getBoolean(R.styleable.WaveformSeekBar_isRecorder, true)
        }
        ta.recycle()
    }
    ...
    fun setWaveRecorder(isRecorder: Boolean) {
      progressProps.isRecorder = isRecorder
      invalidate()
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val waveSample = if(progressProps.isRecorder) sample.copyOfRange(sample.size - if(sample.size > totalBar) totalBar else sample.size, sample.size) else sample
