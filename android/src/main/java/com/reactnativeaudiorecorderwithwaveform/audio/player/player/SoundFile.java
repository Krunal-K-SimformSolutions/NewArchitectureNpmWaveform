package com.reactnativeaudiorecorderwithwaveform.audio.player.player;
...
import com.reactnativeaudiorecorderwithwaveform.audio.player.player.mp4.MP4Header;
import com.reactnativeaudiorecorderwithwaveform.audio.player.player.wav.WAVHeader;
...
public class SoundFile {
    ...
    // TODO(Faralli): what is the real list of supported extensions? Is it device dependent?
    ...
    private void ReadFile(File inputFile)
        ...
        mChannels = format != null ? format.getInteger(MediaFormat.KEY_CHANNEL_COUNT) : 0;
